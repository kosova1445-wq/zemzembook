...
(()=>{
  ...
  facebook.href='https://www.facebook.com/zemzemhouse';
  ...
  facebook.setAttribute('aria-label','Hap ZemZem House në Facebook');
  facebook.innerHTML='<span class="zemzem-facebook-label">Facebook</span><span class="zemzem-facebook-icon" aria-hidden="true"><svg viewBox="0 0 32 32"><path fill="currentColor" d="M18.2 28V17.1h3.66l.55-4.25H18.2v-2.71c0-1.23.34-2.07 2.1-2.07h2.24V4.28a30.1 30.1 0 0 0-3.27-.17c-3.23 0-5.44 1.97-5.44 5.59v3.15h-3.65v4.25h3.65V28h4.37Z"/></svg></span>';
