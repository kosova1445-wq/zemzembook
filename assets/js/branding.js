(()=>{
  ...
  if(!document.querySelector('script[data-site-manager-advanced-runtime]')){const s=document.createElement('script');s.src='assets/js/site-manager-advanced-runtime.js?v=2';s.defer=true;s.dataset.siteManagerAdvancedRuntime='1';document.head.appendChild(s)}
  'use strict';
