...
function resetBookForm(){activeBook=null;ensureBookGalleryFields();$('#bookForm').reset();$('#bookId').value='';$('#bookLanguage').value='sq';$('#bookStatus').value='draft';$('#bookFormat').value='physical';$('#bookStock').value='0';$('#bookLowStock').value='5';$('#bookTrackStock').checked=true;$('#bookCoverUrl').value='';$('#coverPreview').innerHTML='Pa kopertinë';renderBookGalleryFields([]);$('#bookModalTitle').textContent='Libër fizik i ri';$('#deleteBookBtn').hidden=true;$('#bookSlug').dataset.manual='';$('#stockHistoryBox')?.remove()}
