...
function resetBookForm(){activeBook=null;ensureBookGalleryFields();$('#bookForm').reset();$('#bookId').value='';$('#bookLanguage').value='sq';$('#bookBadgeText').value='';$('#bookBadgeStyle').value='default';$('#bookOfferEnds').value='';$('#bookReleaseDate').value='';$('#bookCountry').value='';$('#bookDimensions').value='';$('#bookWeight').value='';$('#bookStatus').value='draft';$('#bookFormat').value='physical';$('#bookStock').value='0';$('#bookLowStock').value='5';$('#bookTrackStock').checked=true;$('#bookCoverUrl').value='';$('#bookSpineCoverUrl').value='';$('#bookBackCoverUrl').value='';$('#bookCoverMode').value='flat';$('#bookThickness').value='';$('#bookSpineCover').value='';$('#bookBackCover').value='';$('#coverPreview').innerHTML='Pa kopertinë';refreshBook3dPreview();renderBookGalleryFields([]);$('#bookModalTitle').textContent='Libër fizik i ri';$('#deleteBookBtn').hidden=true;$('#bookSlug').dataset.manual='';$('#stockHistoryBox')?.remove()}
