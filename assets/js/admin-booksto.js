(()=>{
  ...
  function rebuildSidebar(){
    ...
    frag.append(section('ADMIN'));if(ordersBtn)frag.append(ordersBtn);frag.append(extraCatalog('Category Lists',1));frag.append(extraCatalog('Author',0));if(booksBtn)frag.append(booksBtn);if(addBookBtn)frag.append(addBookBtn);if(ebook)frag.append(ebook);if(catalogBtn)frag.append(catalogBtn);if(customersBtn)frag.append(customersBtn);if(couponsBtn)frag.append(couponsBtn);if(reviewsBtn)frag.append(reviewsBtn);if(adminsBtn)frag.append(adminsBtn);if(brandingBtn)frag.append(brandingBtn);if(mediaBtn)frag.append(mediaBtn);if(operationsBtn)frag.append(operationsBtn);if(messagesBtn){frag.append(section('KOMUNIKIM'));frag.append(messagesBtn)}if(invoiceCenterBtn||invoiceSettingsBtn){frag.append(section('FATURAT'));if(invoiceCenterBtn)frag.append(invoiceCenterBtn);if(invoiceSettingsBtn)frag.append(invoiceSettingsBtn);}
