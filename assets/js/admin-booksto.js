(()=>{
  ...
  function loadBlogModule(){if(document.querySelector('script[src*="admin-blog.js"]'))return;const s=document.createElement('script');s.src='assets/js/admin-blog.js?v=2';document.body.appendChild(s)}
