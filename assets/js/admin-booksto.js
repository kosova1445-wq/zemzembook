(()=>{
  ...
  function loadBlogModule(){if(!document.querySelector('script[src*="admin-blog.js"]')){const s=document.createElement('script');s.src='assets/js/admin-blog.js?v=3';document.body.appendChild(s)}if(!document.querySelector('script[src*="admin-blog-final.js"]')){const x=document.createElement('script');x.src='assets/js/admin-blog-final.js?v=1';document.body.appendChild(x)}}
