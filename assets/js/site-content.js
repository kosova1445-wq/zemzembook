(()=>{
  ...
  function applyDesign(c){
    ...
    cats.slice(0,6).forEach((x,i)=>{css+=`.zemzem-bookstore-v2 .premium-category-list .category-item:nth-child(${i+1}){background:${x}!important;border-color:${shade(x,-18)}!important}.zemzem-bookstore-v2 .premium-category-list .category-item:nth-child(${i+1}) .category-icon{background:${shade(x,-8)}!important}`});
